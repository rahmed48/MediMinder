...
export default class NotifService {
  ...
  scheduleNotif({id, date, sound, title, message}) {
    console.log(date);
    // this.lastId++;
    PushNotification.localNotificationSchedule({
      date: new Date(date - 7 * 60 * 60 * 1000), // in 30 secs
      channelId: sound ? 'sound-channel-id' : 'default-channel-id',
      ticker: 'My Notification Ticker', // (optional)
      autoCancel: true, // (optional) default: true
      ...
      soundName: sound ? sound : 'default', // (optional) Sound to play when the notification is shown. Value of 'default' plays the default sound. It can be set to a custom sound such as 'android.resource://com.xyz/raw/my_sound'. It will look for the 'my_sound' audio file in 'res/raw' directory and play it. default: 'default' (default sound is played)
      number: 10, // (optional) Valid 32 bit integer specified as string. default: none (Cannot be zero)
      repeatType: 'day',
      repeatTime: 1, // repeats every day
    });
  }
  cautionScheduleNotif({id, date, sound, title, message}) {
    // this.lastId++;
    PushNotification.localNotificationSchedule({
      date: new Date(date - 7 * 60 * 60 * 1000 - 5 * 60 * 1000), // in 30 secs
      channelId: sound ? 'sound-channel-id' : 'default-channel-id',
      ticker: 'My Notification Ticker', // (optional)
      autoCancel: true, // (optional) default: true
      color: 'blue', // (optional) default: system default
